...
const STRINGS = {
  en: {
    ...
    donate_how_title: "How it works",
    donate_step_label: "Step",
    donate_step1: "Pick a need that matches your blood group",
    donate_step2: "Confirm — we text hospital details to your phone",
    donate_step3: "Donate safely — coordinator tracks everything",
    donate_needs_title: "Open blood needs",
    donate_needs_subtitle: "Tap a card to volunteer. We'll text the hospital details to your phone.",
    donate_filter_label: "Filter",
    donate_load_error: "Could not load open needs. Please try again in a moment.",
    donate_donor_block_title: "Already donated before?",
    donate_donor_block_subtitle:
      "See your donation history, eligibility, and badges in the donor portal.",
    donate_donor_block_cta: "Open my donor dashboard",
    donate_track_link: "Already registered? Track your request",
  ...
  te: {
    ...
    donate_how_title: "ఎలా పని చేస్తుంది",
    donate_step_label: "దశ",
    donate_step1: "మీ రక్త గ్రూపుకు సరిపోయే అవసరాన్ని ఎంచుకోండి",
    donate_step2: "ధృవీకరించండి — ఆసుపత్రి వివరాలు SMS చేస్తాం",
    donate_step3: "సురక్షితంగా దానం చేయండి — కో-ఆర్డినేటర్ ట్రాక్ చేస్తారు",
    donate_needs_title: "తెరిచి ఉన్న రక్త అవసరాలు",
    donate_needs_subtitle: "దానం చేయడానికి కార్డ్‌ను ట్యాప్ చేయండి. ఆసుపత్రి వివరాలు మీ ఫోన్‌కి SMS చేస్తాం.",
    donate_filter_label: "ఫిల్టర్",
    donate_load_error: "అవసరాలు లోడ్ కాలేదు. కొంత సమయం తర్వాత మళ్లీ ప్రయత్నించండి.",
    donate_donor_block_title: "ముందు దానం చేశారా?",
    donate_donor_block_subtitle:
      "మీ దాన చరిత్ర, అర్హత మరియు బ్యాడ్జ్‌లు దాత పోర్టల్‌లో చూడండి.",
    donate_donor_block_cta: "నా దాత డాష్‌బోర్డ్ తెరవండి",
    donate_track_link: "ఇప్పటికే నమోదు చేశారా? మీ అభ్యర్థనను ట్రాక్ చేయండి",
  ...
  hi: {
    ...
    donate_how_title: "यह कैसे काम करता है",
    donate_step_label: "चरण",
    donate_step1: "अपने ब्लड ग्रुप से मेल खाती ज़रूरत चुनें",
    donate_step2: "पुष्टि करें — अस्पताल की जानकारी SMS करेंगे",
    donate_step3: "सुरक्षित रूप से दान करें — समन्वयक सब ट्रैक करता है",
    donate_needs_title: "खुली रक्त ज़रूरतें",
    donate_needs_subtitle: "दान करने के लिए कार्ड टैप करें. अस्पताल की जानकारी आपके फोन पर SMS होगी.",
    donate_filter_label: "फ़िल्टर",
    donate_load_error: "ज़रूरतें लोड नहीं हो सकीं. कृपया थोड़ी देर बाद फिर कोशिश करें.",
    donate_donor_block_title: "पहले दान किया है?",
    donate_donor_block_subtitle:
      "दाता पोर्टल में अपना दान इतिहास, पात्रता और बैज देखें.",
    donate_donor_block_cta: "मेरा दाता डैशबोर्ड खोलें",
    donate_track_link: "पहले से रजिस्टर हैं? अपनी रिक्वेस्ट ट्रैक करें",
